...
export async function POST(req: Request) {
  ...
  // ✅ Correction ici : on attend headers()
  ...
  try {
    ...
    if (eventType === 'user.created') {
      ...
      if (newUser && newUser._id) {
        if (clerkClient && clerkClient.users && typeof clerkClient.users.updateUserMetadata === 'function') {
          ...
          console.error('Clerk client users object is not properly loaded.');
        }
      }
